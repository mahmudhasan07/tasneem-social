...
import ReviewWay from './ReviewWay';
...
const Page = () => {
    ...
    const features = [
        {
            title: "Attract new customers with more 5-star reviews",
            description:
                "Positive feedback from satisfied customers builds trust and credibility.",
            imgSrc: "/images/chatting.png", // Replace with correct path
        },
        {
            title: "Get more reviews, more leads, more revenue.",
            description:
                "Get your business to the top of the page on Google with more 5-star reviews—93% say online reviews had an impact on their buying decisions. By becoming the obvious choice, you'll convert new leads faster.",
            imgSrc: "/images/strategic.png", // Replace with correct path
        },
        {
            title: "Rank higher on Google with better reviews.",
            description:
                "Get your business to the top of the page on Google with more 5-star reviews—93% say online reviews had an impact on their buying decisions. By becoming the obvious choice, you'll convert new leads faster.",
            imgSrc: "/images/fb.png", // Replace with correct path
        },
        {
            title: "Get found on Facebook faster by new customers",
            description:
                "When people search for businesses on Facebook, they’re going to find and choose the one with the best reviews—and with Feedbird, that’ll be your business.",
            imgSrc: "/images/connect.png", // Replace with correct path
        },
    ];
            ...
            <div className='container mx-auto'>
                <section className="px-4 md:px-20 lg:px-40 py-10">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className={`flex flex-col md:flex-row items-center gap-10 py-8 ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''
                                }`}
                        >
                            ...
                            <div className="md:w-1/2" data-aos="fade-right">
                                ...
                                <p className="text-gray-600 text-lg pb-8">{feature.description}</p>
                                <button className='rounded-[24px] bg-white px-7 py-2 text-primary border-primary border hover:shadow-lg hover:scale-105 transition-all'>Book a demo</button>
                            </div>
                        </div>
                    ))}
