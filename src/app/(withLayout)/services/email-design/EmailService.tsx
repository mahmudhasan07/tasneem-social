...
const EmailService = () => {
  ...
  return (
    <section className="lg:py-20 py-10 lg:px-28 space-y-5 md:px-12 px-5">
      ...
      <div className="flex flex-wrap flex-row-reverse gap-10 bg-white py-6 justify-between" data-aos="fade-up">
        <div
          id="provide"
              ...
              (e: OptionsInterface, idx: number) => (
                ...
                >
                  <div className="space-y-7 relative">
                    <p
                      className={`px-3 py-1 border-2 w-fit rounded-lg absolute text-sm -top-3 bg-[#475467] text-white ${idx == 1 ? "block" : "hidden"
                        }`}
                    >
                      Most popular
                    </p>
