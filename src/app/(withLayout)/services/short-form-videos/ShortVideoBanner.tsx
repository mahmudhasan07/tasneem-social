...
import shortVideoBanner from "@/assets/images/short-video-banner.png";
    ...
    <section className=" lg:py-20 py-10 lg:px-28 md:px-12 px-5">
      ...
      <div className="">
        ...
        <div id="main_content" className="flex flex-wrap gap-5 justify-between">
          <div id="banner_left" className="lg:w-[47%] my-auto ">
            <h1 className="md:text-5xl text-3xl poppins-semibold md:leading-tight leading-snug">
            Create <span id="social">Short-From</span>{" "}
              <span id="management">Video Content</span> starting at <span className="text-red-600">$99</span>/month.
            </h1>
            <p className="md:text-lg my-5">
              Tailored social media content of the highest quality, crafted for
          ...
          <div id="banner_right" className="flex gap-5 lg:w-[47%]">
            <div className="my-auto space-y-6"></div>
            <Image width={300} src={shortVideoBanner} alt="banner1"></Image>
            <Image width={300} src={shortVideoBanner} alt="banner2"></Image>
        ...
        <div
          id="banner_footer"
          className="bg-white px-6 relative z-50 py-4  mt-20 w-96 rounded-xl ml-auto"
        >
...
export default ShortVideoBanner;
